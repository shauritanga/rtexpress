...
export default function WarehousesIndex({ warehouses, stats, filters }: Props) {
    ...
    const getStatusBadge = (status: string) => {
        ...
        const config = statusConfig[status as keyof typeof statusConfig] || { label: status, variant: 'default' as const, icon: Activity };
        ...
        <AppLayout>
            ...
            <div className="space-y-6 p-4 md:p-6">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">Warehouse Management</h1>
                        <p className="mt-1 text-sm text-muted-foreground sm:text-base">Manage warehouse facilities and operations</p>
                    </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">{stats.active_warehouses} active</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">{stats.avg_utilization}% avg utilization</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Search and filter warehouses by various criteria</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>All warehouse facilities and their operational status</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <ResponsiveTable
                                ...
                                },
                                {
                                    ...
                                    render: (value, warehouse) => (
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">of {formatNumber(warehouse.capacity)}</p>
                                        </div>
                                    ),
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    render: (value, warehouse) => (
                                        <div className="flex items-center space-x-2 text-sm">
                                            ...
                                            <span className="text-muted-foreground">{warehouse.short_operating_hours || '24/7'}</span>
                                        </div>
                                    ),
                                },
                                {
