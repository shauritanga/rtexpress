...
import { AlertTriangle, CheckCircle, Clock, CreditCard, DollarSign, Download, Eye, Filter, RefreshCw, Search, XCircle } from 'lucide-react';
            ...
            <div className="space-y-6 p-4 md:p-6">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground sm:text-base">Monitor and manage all payment transactions</p>
                    </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-green-600">
                                        {stats.total_payments > 0 ? Math.round((stats.completed_payments / stats.total_payments) * 100) : 0}% success
                                        rate
                                    </p>
                                </div>
                            </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Gateway fees</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Search and filter payments by various criteria</CardDescription>
                    </CardHeader>
                    <CardContent>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead className="hidden min-w-[100px] sm:table-cell">Date</TableHead>
                                                    ...
                                                    <TableCell>
                                                        <div>
                                                            ...
                                                            {payment.gateway_transaction_id && (
                                                                <p className="text-xs text-muted-foreground">{payment.gateway_transaction_id}</p>
                                                            )}
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
